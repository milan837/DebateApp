...
public class RecyclerViewAdapterNewsDebateList extends RecyclerView.Adapter<RecyclerViewAdapterNewsDebateList.MyviewHolder> {
    Context context;
    List<News> list;

    public RecyclerViewAdapterNewsDebateList(Context context, List<News> list) {
