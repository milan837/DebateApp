...
public class RecyclerViewUserProfileAdapterDebate extends RecyclerView.Adapter<RecyclerViewUserProfileAdapterDebate.MyviewHolder> {
    Context context;
    List<Debate> list;

    public RecyclerViewUserProfileAdapterDebate(Context context, List<Debate> list) {
