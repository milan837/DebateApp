...
public class RecyclerViewAdapterTeamB extends RecyclerView.Adapter<RecyclerViewAdapterTeamB.MyviewHolder> {
    Context context;
    List<TeamUser> list;

    public RecyclerViewAdapterTeamB(Context context, List<TeamUser> list) {
