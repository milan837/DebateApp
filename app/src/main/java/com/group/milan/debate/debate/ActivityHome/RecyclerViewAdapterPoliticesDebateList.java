...
public class RecyclerViewAdapterPoliticesDebateList extends RecyclerView.Adapter<RecyclerViewAdapterPoliticesDebateList.MyviewHolder> {
    Context context;
    List<Politice> list;

    public RecyclerViewAdapterPoliticesDebateList(Context context, List<Politice> list) {
