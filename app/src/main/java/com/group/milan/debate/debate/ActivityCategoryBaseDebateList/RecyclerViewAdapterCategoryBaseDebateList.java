...
public class RecyclerViewAdapterCategoryBaseDebateList extends RecyclerView.Adapter<RecyclerViewAdapterCategoryBaseDebateList.MyviewHolder> {
    Context context;
    List<Response> list;

    public RecyclerViewAdapterCategoryBaseDebateList(Context context, List list) {
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view=layoutInflater.inflate(R.layout.adapter_recyclerview_debate_layout,viewGroup,false);
