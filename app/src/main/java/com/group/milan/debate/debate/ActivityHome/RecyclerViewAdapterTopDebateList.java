...
public class RecyclerViewAdapterTopDebateList extends RecyclerView.Adapter<RecyclerViewAdapterTopDebateList.MyviewHolder> {
    Context context;
    List<TopDebate> list;

    public RecyclerViewAdapterTopDebateList(Context context, List<TopDebate> list) {
