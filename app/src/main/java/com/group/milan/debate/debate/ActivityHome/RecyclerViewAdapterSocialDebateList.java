...
public class RecyclerViewAdapterSocialDebateList extends RecyclerView.Adapter<RecyclerViewAdapterSocialDebateList.MyviewHolder> {
    Context context;
    List<Social> list;

    public RecyclerViewAdapterSocialDebateList(Context context, List<Social> list) {
